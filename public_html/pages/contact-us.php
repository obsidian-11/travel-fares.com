    ...
    <div class="text-center">
      <img
        src="newimages/inner-page-banner.webp"
      ...
      <article>
        <div class="container pt-5">
          <div>
            ...
            <p>
              At Travel Fares we're constantly satisfied to get with both new
            ...
            <ul class="contact-ul">
              <!--<li class="contact-call"><svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="#fff" viewBox="0 0 512 512"><title>Location</title><path d="M256 32C167.67 32 96 96.51 96 176c0 128 160 304 160 304s160-176 160-304c0-79.49-71.67-144-160-144zm0 224a64 64 0 1164-64 64.07 64.07 0 01-64 64z"/></svg> Building No: 6, Surve No: 50/B, Street: Lalpar Main Road, City: Morbi, Gujarat, 363642</li>-->
              <li>
                <a href="tel:+1-888-814-6264" class="contact-call"
                  ><svg
              ...
              <li>
                <a href="mailto:info@travel-fares.com" class="contact-call"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16px"
                    height="16px"
                    ...
                    viewbox="0 0 512 512"
                  >
                    <title>info@travel-fares.com</title>
                    <path
        ...
        <div class="container pt-5 pb-5">
          <div class="book-form-box">
            ...
            <div id="main-error-container" style="padding-bottom: 0.5rem">
              <label class="error">
                Please fill up all required fields before submitting the form.
              </label>
            </div>
            <div class="completion-msg-container hide">
              <label> [message] </label>
            </div>
            <div class="pt-2 default-form" id="contact-form">
              <form action="#">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-8 col-md-4 col-sm-6">
                    <div class="field-label">
